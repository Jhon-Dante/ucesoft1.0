...
<div class="form-group">
	...
	{!! Form::select('tenencia', ['Propio', 'Alquilado'], ['class' => 'form-control', 'title' => 'Seleccione la nacionalidad del personal']) !!}
</div>
<div class="form-group">
	{!! Form::label('nacimiento','Fecha de nacimiento') !!}
	{!! Form::date('nacimiento',null,['class' => 'form-control', 'title' => 'Ingrese la fecha de nacimiento del personal']) !!}
</div>
<div class="form-group">
...
<div class="form-group">
	...
	{!! Form::select('sexo', ['M', 'F'], ['class' => 'form-control', 'title' => 'Seleccione la nacionalidad del personal']) !!}
</div>
<div class="form-group">
...
<div class="form-group">
	...
	{!! Form::text('municipio',null,['class' => 'form-control','placeholder' => 'Ej: José Felix Rivas', 'title' => 'Ingrese el municipio del personal']) !!}
</div>
<div class="form-group">
	{!! Form::label('ciudad','Ciudad') !!}
	{!! Form::text('ciudad',null,['class' => 'form-control','placeholder' => 'Ej: La Victoria', 'title' => 'Ingrese la ciudad del personal']) !!}
</div>
<div class="form-group">
	{!! Form::label('estado','Estado') !!}
	{!! Form::select('estado', ['Aragua', 'Caracas','Guarico'], ['class' => 'form-control', 'title' => 'Seleccione el estado del personal']) !!}
</div>
<div class="form-group">
	{!! Form::label('pais','Pais') !!}
	{!! Form::text('pais',null,['class' => 'form-control','placeholder' => 'Ej: Venezuela', 'title' => 'Ingrese el pais del personal']) !!}
</div>

<div class="form-group">
	{!! Form::label('telf_movil','Teléfono móvil') !!}
	{!! Form::text('telf_movil',null,['class' => 'form-control','placeholder' => 'Ej: 04162455643', 'title' => 'Ingrese el teléfono móvil del personal']) !!}
</div>

<div class="form-group">
	{!! Form::label('telf_fijo','Teléfono fijo') !!}
	{!! Form::text('telf_fijo',null,['class' => 'form-control','placeholder' => 'Ej: 02446675544', 'title' => 'Ingrese el teléfono de habitación del personal']) !!}
</div>
...
<div class="form-group">
	...
	{!! Form::text('titulo',null,['class' => 'form-control','placeholder' => 'Ej: Educación', 'title' => 'Ingrese el título del personal']) !!}
</div>
<div class="form-group">
	{!! Form::label('mencion','Mención') !!}
	{!! Form::text('mencion',null,['class' => 'form-control','placeholder' => 'Ej: Orientación', 'title' => 'Ingrese la mención del personal']) !!}
</div>
<div>
	{!! Form::label('cargo','Cargo') !!}
	{!! Form::select('id_tipoPersonal', $tipos, null, ['class' => 'form-control', 'title' => 'Seleccione el tipo de personal']) !!}	
</div>
<div>
	{!! Form::label('cargo','Cargo') !!}
