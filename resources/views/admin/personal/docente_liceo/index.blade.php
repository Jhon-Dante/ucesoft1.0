...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Liceo')
        <small></small>
    </h1>
    <div class="col-md-12">
            <!-- mensaje flash -->
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="panel panel-default">
            <div class="panel-heading">Lista del estudiante de Liceo registrado
          ...
          <div class="panel-body">
            ...
            <tbody>
              <tr>
                <td><a href="#">1</a></td>
                <td><a href="#">Juan</a></td>
                <td><a href="#">Sumoza</a></td>
                <td><a href="#">V-11111443</a></td>
                <td><a href="#">1er año.</a></td>
                <td><a href="#">U</a></td>
