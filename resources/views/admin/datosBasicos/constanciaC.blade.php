...
<section class="content-header">
    <h1>
        ...
        <small>Generar Certificado de Calificaciones</small>
    </h1>
    <div class="col-md-12">
            <!-- mensaje flash -->
    </div>
    <ol class="breadcrumb">
        ...
        <li class="active">Certificado de Calificaciones</li>
    </ol>
</section>
<!-- Main content -->
<section class="content">
	...
	<div class="box box-warning direct-chat direct-chat-warning">
	                ...
	                <div class="box-body">
	                  ...
	                  {!! Form::open(['route' => ['admin.mostrarConstanciaC'], 'method' => 'post', 'role' => 'form']) !!}
				    		<div class="col-xs-12">
