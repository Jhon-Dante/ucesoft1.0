        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              	@foreach($inscripcion as $key)
					...
					<td>
						@if($lapso1==1)
						<a href="{{ route('admin.boletin.pdf2', ['id_datosBasicos' => $key->id_datosBasicos, 'id_seccion' => $seccion->id, 'id_periodo => '$id_periodo]) }}"><button class="btn btn-info btn-flat" title="Presionando este botón puede editar el registro"><i class="fa fa-file-pdf-o"></i></button></a>
						@endif
					</td>
