...
class CreatePersonalpHasSeccionesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('personalp_has_secciones', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('personalp_has_secciones');
    }
}
